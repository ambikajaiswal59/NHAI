        ...
        <div ref={dropdownRef} style={{ position: "relative", display: "inline-block" }}>
            ...
            {isOpen && (
                <div style={{
                    ...
                    maxHeight: isMobile ? "150px" : maxHeight,
                    overflowY: "auto",
                    zIndex: 1000,
                    minWidth: "140px",
                }}>
            ...
            <div style={{
                ...
                <div style={{ minWidth: 0, flex: 1 }}>
                    ...
                    <p style={{
                        ...
                        Traffic Analysis {displayDate ? `for ${formatDateDisplay(displayDate)}` : "Loading..."}
                    </p>
                </div>
...
// import { Activity, ArrowUp, ArrowDown, AlertTriangle, X, Calendar } from "lucide-react";
// import {
//     LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend,
//     ResponsiveContainer, ReferenceLine, ReferenceArea, ComposedChart
// } from 'recharts';

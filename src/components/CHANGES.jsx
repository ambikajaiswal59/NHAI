...
//  Before changing map from osm to google map
...
//   // Leaflet doesn't auto-detect a resize of its container — needed
//   // since this component's height now comes from a flex-based parent
...
//     >
//       {/* Column 1 — map. min-w-0 lets it shrink to absorb any width
//           pressure instead of the sidebar getting squeezed/clipped. */}
...
//         <div className="absolute top-33 left-3 z-[500]">
//           <FullscreenButton
...
//       {/* Column 2 — fixed width (lg:w-[380px]), shrink-0 so it NEVER
//           compresses or clips. Comfortable width for a 2-col stat card
//           grid without truncating labels like "Critical Structures". */}
//       {!isFullscreen && (
...
//  After changing map from osm to google map
